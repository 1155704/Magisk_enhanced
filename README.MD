...
If you are reading this as a developper working on these devices or another one which is non compliant in the same way, please do the necessary changes so that the device becomes compliant.
