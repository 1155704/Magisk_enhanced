...
If all the 4 above conditions are not met your device should be compatible with the official version of magisk which you should use instead of this one.
