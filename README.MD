...
If the app found something to patch from the image file you selected it will do so, but that doesn't mean booting or rooting with it will always work. You might have to try different images.
