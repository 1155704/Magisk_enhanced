...
Some android devices have boot structures that dont comply the android standards designed by Google and the official version of magisk doesn't support them. This is the case of the Xiaomi Redmi Pad SE 8.7 (codenames "flare" and "spark") and more.
