...
Some android devices have boot structures that do not respect the android standards designed by Google and Magisk doesn't support them. This unofficial version does.
