...
Here's how:
 ...
 - the boot_patch.sh file from the /script folder above on this repository ( https://github.com/NeutroGe/Vendor_boot_img_patcher_tool/blob/master/scripts/boot_patch.sh )
